...
#ifndef __classify_mul_mul_csw__HH__
#define __classify_mul_mul_csw__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(classify_mul_mul_csw) {
    ...
    SC_CTOR(classify_mul_mul_csw):  ACMP_smul_ss_U ("ACMP_smul_ss_U") {
