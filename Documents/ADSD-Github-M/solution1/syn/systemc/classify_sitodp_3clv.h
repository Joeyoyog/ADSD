...
#ifndef __classify_sitodp_3clv__HH__
#define __classify_sitodp_3clv__HH__
...
template<
    ...
    int din0_WIDTH,
    int dout_WIDTH>
SC_MODULE(classify_sitodp_3clv) {
    ...
    SC_CTOR(classify_sitodp_3clv):  ACMP_sitodp_U ("ACMP_sitodp_U") {
