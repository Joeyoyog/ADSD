...
#ifndef __classify_mul_8s_8cmv__HH__
#define __classify_mul_8s_8cmv__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(classify_mul_8s_8cmv) {
    ...
    SC_CTOR(classify_mul_8s_8cmv):  ACMP_smul_ss_U ("ACMP_smul_ss_U") {
