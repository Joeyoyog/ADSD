...
#ifndef __classify_sitodp_3dEe__HH__
#define __classify_sitodp_3dEe__HH__
...
template<
    ...
    int din0_WIDTH,
    int dout_WIDTH>
SC_MODULE(classify_sitodp_3dEe) {
    ...
    SC_CTOR(classify_sitodp_3dEe):  ACMP_sitodp_U ("ACMP_sitodp_U") {
