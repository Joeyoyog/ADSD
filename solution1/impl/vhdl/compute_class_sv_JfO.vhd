...
entity compute_class_sv_JfO_rom is 
    generic(
             DWIDTH     : integer := 30; 
             AWIDTH     : integer := 4; 
             MEM_SIZE    : integer := 11
...
architecture rtl of compute_class_sv_JfO_rom is 
...
entity compute_class_sv_JfO is
    generic (
...
architecture arch of compute_class_sv_JfO is
    component compute_class_sv_JfO_rom is
        port (
            clk : IN STD_LOGIC;
...
begin
    compute_class_sv_JfO_rom_U :  component compute_class_sv_JfO_rom
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,
