...
entity compute_class_sv_Rg6_rom is 
    generic(
             DWIDTH     : integer := 28; 
             AWIDTH     : integer := 4; 
             MEM_SIZE    : integer := 10
...
architecture rtl of compute_class_sv_Rg6_rom is 
...
entity compute_class_sv_Rg6 is
    generic (
...
architecture arch of compute_class_sv_Rg6 is
    component compute_class_sv_Rg6_rom is
        port (
            clk : IN STD_LOGIC;
...
begin
    compute_class_sv_Rg6_rom_U :  component compute_class_sv_Rg6_rom
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,
