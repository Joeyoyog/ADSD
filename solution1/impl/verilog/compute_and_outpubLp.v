...
`timescale 1 ns / 1 ps
(* rom_style = "block" *) module compute_and_outpubLp_rom (
...
initial begin
    $readmemh("./compute_and_outpubLp_rom.dat", ram0);
    $readmemh("./compute_and_outpubLp_rom.dat", ram1);
    $readmemh("./compute_and_outpubLp_rom.dat", ram2);
    $readmemh("./compute_and_outpubLp_rom.dat", ram3);
end
...
compute_and_outpubLp_rom compute_and_outpubLp_rom_U(
    .clk( clk ),
    .addr0( address0 ),
    .ce0( ce0 ),
    .q0( q0 ),
