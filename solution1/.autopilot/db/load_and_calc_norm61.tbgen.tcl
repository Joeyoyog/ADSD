set moduleName load_and_calc_norm61
...
set C_modelName {load_and_calc_norm61}
...
set C_modelArgList {
	...
	{ n_0_i_i_out int 12 regular {fifo 1}  }
}
set C_modelArgMapList {[ 
	{ "Name" : "in_stream_V_data_V", "interface" : "axis", "bitwidth" : 64, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "n_0_i_i_out", "interface" : "fifo", "bitwidth" : 12, "direction" : "WRITEONLY"} , 
...
set portList { 
	...
	{ n_0_i_i sc_in sc_lv 12 signal 23 } 
	{ n_0_i_i_out_din sc_out sc_lv 12 signal 24 } 
	{ n_0_i_i_out_full_n sc_in sc_logic 1 signal 24 } 
	{ n_0_i_i_out_write sc_out sc_logic 1 signal 24 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "n_0_i_i_out_din", "direction": "out", "datatype": "sc_lv", "bitwidth":12, "type": "signal", "bundle":{"name": "n_0_i_i_out", "role": "din" }} , 
 	{ "name": "n_0_i_i_out_full_n", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "n_0_i_i_out", "role": "full_n" }} , 
 	{ "name": "n_0_i_i_out_write", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "n_0_i_i_out", "role": "write" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "",
		...
		"Port" : [
			...
			{"Name" : "n_0_i_i_out", "Type" : "Fifo", "Direction" : "O", "DependentProc" : "0", "DependentChan" : "0",
				"BlockSignal" : [
...
set Spec2ImplPortList { 
	...
	n_0_i_i { ap_none {  { n_0_i_i in_data 0 12 } } }
	n_0_i_i_out { ap_fifo {  { n_0_i_i_out_din fifo_data 1 12 }  { n_0_i_i_out_full_n fifo_status 0 1 }  { n_0_i_i_out_write fifo_update 1 1 } } }
}
