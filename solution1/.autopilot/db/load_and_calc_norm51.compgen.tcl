...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename x_pack_V \
    op interface \
    ports { x_pack_V_address1 { O 5 vector } x_pack_V_ce1 { O 1 bit } x_pack_V_we1 { O 1 bit } x_pack_V_d1 { O 128 vector } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'x_pack_V'"
}
}
