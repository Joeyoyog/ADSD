...
set ID 125
set hasByteEnable 0
set MemName dataflow_in_loop_bAo_memcore
...
set MemName dataflow_in_loop_bAo
...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_n \
    op interface \
    ports { n { I 31 vector } n_ap_vld { I 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { num_images { I 32 vector } num_images_ap_vld { I 1 bit } } \
} "
}
