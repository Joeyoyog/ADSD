...
const Port_Property HLS_Design_Meta::port_props[]={
	...
	Port_Property("in_stream_TDATA", 64, hls_in, 0, "axis", "in_data", 1),
	Port_Property("in_stream_TKEEP", 8, hls_in, 1, "axis", "in_data", 1),
	Port_Property("in_stream_TSTRB", 8, hls_in, 2, "axis", "in_data", 1),
