...
set ID 97
set hasByteEnable 0
set MemName classify_x_local_1iI_memcore
...
set MemName classify_x_local_1iI
...
set ID 100
set FifoName fifo_w64_d2_A
set InstName result_load_loc_chan_U
set CoreName ap_simcore_fifo
set NumOfStage 2
set RegisteredInput 0
set DualClock 0
...
if {${::AESL::PGuard_simmodel_gen}} {
	if {[info proc ::AESL_LIB_XILADAPTER::s_axilite_gen] == "::AESL_LIB_XILADAPTER::s_axilite_gen"} {
		eval "::AESL_LIB_XILADAPTER::s_axilite_gen { \
			id 101 \
			corename classify_control_axilite \
			name classify_control_s_axi \
			ports {$port_control} \
			op interface \
			is_flushable 0 \ 
		} "
...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler classify_control_s_axi
}
...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler classify_gmem_m_axi
}
