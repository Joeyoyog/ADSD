...
#ifndef __compute_class_sv_QgW_H__
#define __compute_class_sv_QgW_H__
...
struct compute_class_sv_QgW_ram : public sc_core::sc_module {
...
sc_lv<DataWidth> ram[AddressRange];
   ...
   SC_CTOR(compute_class_sv_QgW_ram) {
...
SC_MODULE(compute_class_sv_QgW) {
...
compute_class_sv_QgW_ram* meminst;


SC_CTOR(compute_class_sv_QgW) {
meminst = new compute_class_sv_QgW_ram("compute_class_sv_QgW_ram");
