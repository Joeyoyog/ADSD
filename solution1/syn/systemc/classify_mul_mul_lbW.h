...
#ifndef __classify_mul_mul_lbW__HH__
#define __classify_mul_mul_lbW__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(classify_mul_mul_lbW) {
    ...
    SC_CTOR(classify_mul_mul_lbW):  ACMP_smul_ss_U ("ACMP_smul_ss_U") {
