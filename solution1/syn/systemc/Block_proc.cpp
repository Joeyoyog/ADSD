...
Block_proc::Block_proc(sc_module_name name) : sc_module(name), mVcdFile(0) {
    ...
    SC_METHOD(thread_result_out_V);
    sensitive << ( ap_start );
    sensitive << ( ap_done_reg );
    sensitive << ( ap_CS_fsm_state1 );
    sensitive << ( p_read );
    sensitive << ( result_out_V_preg );

    SC_METHOD(thread_result_out_V_ap_vld);
    sensitive << ( ap_start );
    sensitive << ( ap_done_reg );
    sensitive << ( ap_CS_fsm_state1 );
    ...
    ap_CS_fsm = "1";
    result_out_V_preg = "00000000000000000000000000000000";
    ...
    sc_trace(mVcdFile, result_out_V, "(port)result_out_V");
    sc_trace(mVcdFile, result_out_V_ap_vld, "(port)result_out_V_ap_vld");
#endif
    ...
    sc_trace(mVcdFile, result_out_V_preg, "result_out_V_preg");
...
void Block_proc::thread_result_out_V() {
    if ((!(esl_seteq<1,1,1>(ap_start.read(), ap_const_logic_0) || esl_seteq<1,1,1>(ap_done_reg.read(), ap_const_logic_1)) && 
         esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state1.read()))) {
        result_out_V = p_read.read();
    } else {
        result_out_V = result_out_V_preg.read();
    }
}

void Block_proc::thread_result_out_V_ap_vld() {
    if ((!(esl_seteq<1,1,1>(ap_start.read(), ap_const_logic_0) || esl_seteq<1,1,1>(ap_done_reg.read(), ap_const_logic_1)) && 
         esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state1.read()))) {
        result_out_V_ap_vld = ap_const_logic_1;
    } else {
        result_out_V_ap_vld = ap_const_logic_0;
    }
}
