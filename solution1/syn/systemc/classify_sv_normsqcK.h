...
#ifndef __classify_sv_normsqcK_H__
#define __classify_sv_normsqcK_H__
...
classify_sv_normsqcK_ram* meminst;


SC_CTOR(classify_sv_normsqcK) {
meminst = new classify_sv_normsqcK_ram("classify_sv_normsqcK_ram");
