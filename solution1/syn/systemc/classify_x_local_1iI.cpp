...
void classify_x_local_1iI::proc_tptr() {
    if (reset.read() == SC_LOGIC_1) {
        tptr.write(0);
...
void classify_x_local_1iI::proc_count() {
    if (reset.read() == SC_LOGIC_1) {
        count.write(0);
...
void classify_x_local_1iI::proc_full_n() {
    if (reset.read() == SC_LOGIC_1) {
...
void classify_x_local_1iI::proc_empty_n() {
    if (reset.read() == SC_LOGIC_1) {
