...
#ifndef __classify_mul_mul_UhA__HH__
#define __classify_mul_mul_UhA__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(classify_mul_mul_UhA) {
    ...
    SC_CTOR(classify_mul_mul_UhA):  ACMP_smul_ss_U ("ACMP_smul_ss_U") {
