...
#ifndef __classify_sitodp_6jbC__HH__
#define __classify_sitodp_6jbC__HH__
...
template<
    ...
    int din0_WIDTH,
    int dout_WIDTH>
SC_MODULE(classify_sitodp_6jbC) {
    ...
    SC_CTOR(classify_sitodp_6jbC):  ACMP_sitodp_U ("ACMP_sitodp_U") {
