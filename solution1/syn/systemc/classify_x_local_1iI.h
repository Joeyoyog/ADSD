...
#ifndef _classify_x_local_1iI_H_
#define _classify_x_local_1iI_H_

#include <systemc>
#include <iostream>
#include <fstream>

#include "classify_x_local_1iI_memcore.h"

SC_MODULE(classify_x_local_1iI) {
...
protected:
    ...
    classify_x_local_1iI_memcore* classify_x_local_1iI_memcore_U;
...
public:
    ...
    SC_CTOR(classify_x_local_1iI) : m_trace_file(0) {
        SC_METHOD(proc_memcore_addr);
        sensitive << i_address0 << t_address0 << iptr << tptr;

        classify_x_local_1iI_memcore_U = new classify_x_local_1iI_memcore("classify_x_local_1iI_memcore_U");
        classify_x_local_1iI_memcore_U->clk      ( clk );
        classify_x_local_1iI_memcore_U->reset    ( reset );
        classify_x_local_1iI_memcore_U->ce0      ( i_ce0 );
        classify_x_local_1iI_memcore_U->we0      ( i_we0 );
        classify_x_local_1iI_memcore_U->address0 ( memcore_iaddr );
        classify_x_local_1iI_memcore_U->d0       ( i_d0 );
        classify_x_local_1iI_memcore_U->q0       ( i_q0 );

        classify_x_local_1iI_memcore_U->ce1      ( t_ce0 );
        classify_x_local_1iI_memcore_U->we1      ( t_we0 );
        classify_x_local_1iI_memcore_U->address1 ( memcore_taddr );
        classify_x_local_1iI_memcore_U->d1       ( t_d0 );
        classify_x_local_1iI_memcore_U->q1       ( t_q0 );
        ...
        if (dump_vcd) {
            m_trace_file = sc_create_vcd_trace_file( "classify_x_local_1iI.trace");
            // ports
