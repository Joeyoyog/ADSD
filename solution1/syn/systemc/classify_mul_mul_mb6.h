...
#ifndef __classify_mul_mul_mb6__HH__
#define __classify_mul_mul_mb6__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(classify_mul_mul_mb6) {
    ...
    SC_CTOR(classify_mul_mul_mb6):  ACMP_smul_ss_U ("ACMP_smul_ss_U") {
