...
#ifndef __classify_mac_mulabzo__HH__
#define __classify_mac_mulabzo__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(classify_mac_mulabzo) {
    ...
    SC_CTOR(classify_mac_mulabzo):  simcore_mac_4_U ("simcore_mac_4_U") {
