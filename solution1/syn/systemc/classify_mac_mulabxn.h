...
#ifndef __classify_mac_mulabxn__HH__
#define __classify_mac_mulabxn__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(classify_mac_mulabxn) {
    ...
    SC_CTOR(classify_mac_mulabxn):  simcore_mac_2_U ("simcore_mac_2_U") {
