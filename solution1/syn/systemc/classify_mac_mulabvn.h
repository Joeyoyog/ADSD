...
#ifndef __classify_mac_mulabvn__HH__
#define __classify_mac_mulabvn__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(classify_mac_mulabvn) {
    ...
    SC_CTOR(classify_mac_mulabvn):  simcore_mac_0_U ("simcore_mac_0_U") {
