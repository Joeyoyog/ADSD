...
#ifndef __classify_mul_mul_ibs__HH__
#define __classify_mul_mul_ibs__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(classify_mul_mul_ibs) {
    ...
    SC_CTOR(classify_mul_mul_ibs):  ACMP_smul_ss_U ("ACMP_smul_ss_U") {
