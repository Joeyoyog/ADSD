...
struct Block_proc : public sc_module {
    ...
    sc_out< sc_lv<32> > result_out_V;
    sc_out< sc_logic > result_out_V_ap_vld;
    ...
    sc_signal< sc_lv<32> > result_out_V_preg;
    ...
    void thread_result_out_V();
    void thread_result_out_V_ap_vld();
