...
#ifndef __classify_mul_mul_eOg__HH__
#define __classify_mul_mul_eOg__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(classify_mul_mul_eOg) {
    ...
    SC_CTOR(classify_mul_mul_eOg):  ACMP_smul_us_U ("ACMP_smul_us_U") {
