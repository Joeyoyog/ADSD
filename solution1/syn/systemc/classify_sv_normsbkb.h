...
#ifndef __classify_sv_normsbkb_H__
#define __classify_sv_normsbkb_H__
...
struct classify_sv_normsbkb_ram : public sc_core::sc_module {
...
sc_lv<DataWidth> ram[AddressRange];
   ...
   SC_CTOR(classify_sv_normsbkb_ram) {
...
SC_MODULE(classify_sv_normsbkb) {
...
classify_sv_normsbkb_ram* meminst;


SC_CTOR(classify_sv_normsbkb) {
meminst = new classify_sv_normsbkb_ram("classify_sv_normsbkb_ram");
