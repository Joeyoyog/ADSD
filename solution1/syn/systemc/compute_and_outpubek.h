...
#ifndef __compute_and_outpubek_H__
#define __compute_and_outpubek_H__
...
compute_and_outpubek_ram* meminst;


SC_CTOR(compute_and_outpubek) {
meminst = new compute_and_outpubek_ram("compute_and_outpubek_ram");
