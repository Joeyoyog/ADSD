...
#ifndef __classify_mac_mulabwn__HH__
#define __classify_mac_mulabwn__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(classify_mac_mulabwn) {
    ...
    SC_CTOR(classify_mac_mulabwn):  simcore_mac_1_U ("simcore_mac_1_U") {
