...
#ifndef __classify_mac_mulabyn__HH__
#define __classify_mac_mulabyn__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(classify_mac_mulabyn) {
    ...
    SC_CTOR(classify_mac_mulabyn):  simcore_mac_3_U ("simcore_mac_3_U") {
