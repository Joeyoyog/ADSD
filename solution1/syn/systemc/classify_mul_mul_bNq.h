...
#ifndef __classify_mul_mul_bNq__HH__
#define __classify_mul_mul_bNq__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(classify_mul_mul_bNq) {
    ...
    SC_CTOR(classify_mul_mul_bNq):  ACMP_smul_uu_U ("ACMP_smul_uu_U") {
