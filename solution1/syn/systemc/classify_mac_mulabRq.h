...
#ifndef __classify_mac_mulabRq__HH__
#define __classify_mac_mulabRq__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(classify_mac_mulabRq) {
    ...
    SC_CTOR(classify_mac_mulabRq):  simcore_mac_0_U ("simcore_mac_0_U") {
