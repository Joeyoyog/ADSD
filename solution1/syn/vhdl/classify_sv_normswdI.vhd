...
architecture rtl of classify_sv_normswdI_rom is 
...
architecture arch of classify_sv_normswdI is
    component classify_sv_normswdI_rom is
        port (
            clk : IN STD_LOGIC;
...
begin
    classify_sv_normswdI_rom_U :  component classify_sv_normswdI_rom
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,
