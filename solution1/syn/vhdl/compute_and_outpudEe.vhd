...
architecture rtl of compute_and_outpudEe_rom is 
...
architecture arch of compute_and_outpudEe is
    component compute_and_outpudEe_rom is
        port (
            clk : IN STD_LOGIC;
...
begin
    compute_and_outpudEe_rom_U :  component compute_and_outpudEe_rom
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,
