...
entity classify_sv_normsbkb_rom is 
    generic(
             DWIDTH     : integer := 30; 
             AWIDTH     : integer := 4; 
             MEM_SIZE    : integer := 10
...
architecture rtl of classify_sv_normsbkb_rom is 
...
entity classify_sv_normsbkb is
    generic (
...
architecture arch of classify_sv_normsbkb is
    component classify_sv_normsbkb_rom is
        port (
            clk : IN STD_LOGIC;
...
begin
    classify_sv_normsbkb_rom_U :  component classify_sv_normsbkb_rom
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,
