...
entity compute_class_sv_PgM_rom is 
    generic(
             DWIDTH     : integer := 29; 
             AWIDTH     : integer := 4; 
             MEM_SIZE    : integer := 10
...
architecture rtl of compute_class_sv_PgM_rom is 
...
entity compute_class_sv_PgM is
    generic (
...
architecture arch of compute_class_sv_PgM is
    component compute_class_sv_PgM_rom is
        port (
            clk : IN STD_LOGIC;
...
begin
    compute_class_sv_PgM_rom_U :  component compute_class_sv_PgM_rom
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,
