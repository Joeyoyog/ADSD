...
// [dump_struct_tree [build_nameSpaceTree] dumpedStructList] ---------->
    ...
    template<> struct ap_axiu<64, 1, 1, 1> {
        ap_uint<64> data;
        ap_uint<8> keep;
        ap_uint<8> strb;
        ap_uint<1> user;
        ...
        ap_uint<1> dest;
          ...
          typedef struct result_pkt {
              ap_fixed<32, 16, (ap_q_mode) 5, (ap_o_mode)3, 0> data;
              ap_uint<1> keep;
              ap_uint<1> strb;
              ap_uint<1> last;
             } result_pkt;
...
#define AUTOTB_TVIN_in_stream_V_data_V  "../tv/cdatafile/c.classify.autotvin_in_stream_V_data_V.dat"
...
#define AUTOTB_TVIN_in_stream_V_keep_V  "../tv/cdatafile/c.classify.autotvin_in_stream_V_keep_V.dat"
...
#define AUTOTB_TVIN_in_stream_V_strb_V  "../tv/cdatafile/c.classify.autotvin_in_stream_V_strb_V.dat"
...
#define AUTOTB_TVIN_in_stream_V_user_V  "../tv/cdatafile/c.classify.autotvin_in_stream_V_user_V.dat"
...
#define AUTOTB_TVIN_in_stream_V_last_V  "../tv/cdatafile/c.classify.autotvin_in_stream_V_last_V.dat"
...
#define AUTOTB_TVIN_in_stream_V_id_V  "../tv/cdatafile/c.classify.autotvin_in_stream_V_id_V.dat"
...
#define AUTOTB_TVIN_in_stream_V_dest_V  "../tv/cdatafile/c.classify.autotvin_in_stream_V_dest_V.dat"
...
#define AUTOTB_TVOUT_out_stream_V_data_V  "../tv/cdatafile/c.classify.autotvout_out_stream_V_data_V.dat"
#define AUTOTB_TVIN_out_stream_V_data_V  "../tv/cdatafile/c.classify.autotvin_out_stream_V_data_V.dat"
...
#define AUTOTB_TVOUT_out_stream_V_keep_V  "../tv/cdatafile/c.classify.autotvout_out_stream_V_keep_V.dat"
#define AUTOTB_TVIN_out_stream_V_keep_V  "../tv/cdatafile/c.classify.autotvin_out_stream_V_keep_V.dat"
...
#define AUTOTB_TVOUT_out_stream_V_strb_V  "../tv/cdatafile/c.classify.autotvout_out_stream_V_strb_V.dat"
#define AUTOTB_TVIN_out_stream_V_strb_V  "../tv/cdatafile/c.classify.autotvin_out_stream_V_strb_V.dat"
...
#define AUTOTB_TVOUT_out_stream_V_last_V  "../tv/cdatafile/c.classify.autotvout_out_stream_V_last_V.dat"
#define AUTOTB_TVIN_out_stream_V_last_V  "../tv/cdatafile/c.classify.autotvin_out_stream_V_last_V.dat"
...
// wrapc file define: "num_images"
#define AUTOTB_TVIN_num_images  "../tv/cdatafile/c.classify.autotvin_num_images.dat"

#define INTER_TCL  "../tv/cdatafile/ref.tcl"

// tvout file define: "out_stream_V_data_V"
#define AUTOTB_TVOUT_PC_out_stream_V_data_V  "../tv/rtldatafile/rtl.classify.autotvout_out_stream_V_data_V.dat"
// tvout file define: "out_stream_V_keep_V"
#define AUTOTB_TVOUT_PC_out_stream_V_keep_V  "../tv/rtldatafile/rtl.classify.autotvout_out_stream_V_keep_V.dat"
// tvout file define: "out_stream_V_strb_V"
#define AUTOTB_TVOUT_PC_out_stream_V_strb_V  "../tv/rtldatafile/rtl.classify.autotvout_out_stream_V_strb_V.dat"
// tvout file define: "out_stream_V_last_V"
#define AUTOTB_TVOUT_PC_out_stream_V_last_V  "../tv/rtldatafile/rtl.classify.autotvout_out_stream_V_last_V.dat"
...
class INTER_TCL_FILE {
	public:
		...
		string get_depth_list () {
			...
			total_list << "{num_images " << num_images_depth << "}\n";
...
hls::stream<ap_axiu<64, 1, 1, 1 > > (&in_stream),
hls::stream<result_pkt > (&out_stream),
int num_images);

void AESL_WRAP_classify (
hls::stream<ap_axiu<64, 1, 1, 1 > > (&in_stream),
hls::stream<result_pkt > (&out_stream),
int num_images)
{
	...
	if (wrapc_switch_file_token.good())
	{
		...
		std::vector<result_pkt > aesl_tmp_3;
		int aesl_tmp_4;
		int aesl_tmp_5 = 0;
						...
						// celement: out_stream.V.data.V(31, 0)
						{
							...
							for (int i_0 = aesl_tmp_5; i_0 <= aesl_tmp_4 - 1; i_0 += 1)
							{
								...
								for (int i_1 = 0; i_1 <= 0; i_1 += 1)
								{
									...
									// output_left_conversion : (aesl_tmp_3[i_0].data).range()
									// output_type_conversion : (out_stream_V_data_V_lv0_0_0_1_lv1_0_0_1[hls_map_index]).to_string(SC_BIN).c_str()
									if (&(aesl_tmp_3[0].data) != NULL) // check the null address if the c port is array or others
									{
										(aesl_tmp_3[i_0].data).range() = (out_stream_V_data_V_lv0_0_0_1_lv1_0_0_1[hls_map_index]).to_string(SC_BIN).c_str();
										hls_map_index++;
									}
								}
							}
		...
		if (atoi(AESL_num.c_str()) == AESL_transaction_pc)
		{
			...
			std::vector<sc_bv<1> > out_stream_V_keep_V_pc_buffer;
			int i = 0;
			...
			if (i > 0)
			{
				// RTL Name: out_stream_V_keep_V
				{
					// bitslice(0, 0)
					// {
						// celement: out_stream.V.keep.V(0, 0)
						// {
							sc_lv<1>* out_stream_V_keep_V_lv0_0_0_1_lv1_0_0_1 = new sc_lv<1>[aesl_tmp_4 - aesl_tmp_5];
						// }
					// }
						...
						// celement: out_stream.V.keep.V(0, 0)
						{
							...
							for (int i_0 = aesl_tmp_5; i_0 <= aesl_tmp_4 - 1; i_0 += 1)
							{
								...
								for (int i_1 = 0; i_1 <= 0; i_1 += 1)
								{
									...
									{
										out_stream_V_keep_V_lv0_0_0_1_lv1_0_0_1[hls_map_index].range(0, 0) = sc_bv<1>(out_stream_V_keep_V_pc_buffer[hls_map_index].range(0, 0));
										hls_map_index++;
									}
								}
							}
		...
		if (atoi(AESL_num.c_str()) == AESL_transaction_pc)
		{
			...
			std::vector<sc_bv<1> > out_stream_V_strb_V_pc_buffer;
			int i = 0;
			...
			if (i > 0)
			{
				// RTL Name: out_stream_V_strb_V
				{
					// bitslice(0, 0)
					// {
						// celement: out_stream.V.strb.V(0, 0)
						// {
							sc_lv<1>* out_stream_V_strb_V_lv0_0_0_1_lv1_0_0_1 = new sc_lv<1>[aesl_tmp_4 - aesl_tmp_5];
						// }
					// }
						...
						// celement: out_stream.V.strb.V(0, 0)
						{
							...
							for (int i_0 = aesl_tmp_5; i_0 <= aesl_tmp_4 - 1; i_0 += 1)
							{
								...
								for (int i_1 = 0; i_1 <= 0; i_1 += 1)
								{
									...
									{
										out_stream_V_strb_V_lv0_0_0_1_lv1_0_0_1[hls_map_index].range(0, 0) = sc_bv<1>(out_stream_V_strb_V_pc_buffer[hls_map_index].range(0, 0));
										hls_map_index++;
									}
								}
							}
	...
	else
	{
		...
		// "num_images"
		char* tvin_num_images = new char[50];
		aesl_fh.touch(AUTOTB_TVIN_num_images);
		...
		std::vector<ap_axiu<64, 1, 1, 1 > > aesl_tmp_0;
		int aesl_tmp_1 = 0;
		...
		// [[transaction]]
		sprintf(tvin_num_images, "[[transaction]] %d\n", AESL_transaction);
		aesl_fh.write(AUTOTB_TVIN_num_images, tvin_num_images);

		sc_bv<32> num_images_tvin_wrapc_buffer;

		// RTL Name: num_images
		{
			// bitslice(31, 0)
			{
				// celement: num_images(31, 0)
				{
					// carray: (0) => (0) @ (0)
					{
						// sub                   : 
						// ori_name              : num_images
						// sub_1st_elem          : 
						// ori_name_1st_elem     : num_images
						// regulate_c_name       : num_images
						// input_type_conversion : num_images
						if (&(num_images) != NULL) // check the null address if the c port is array or others
						{
							sc_lv<32> num_images_tmp_mem;
							num_images_tmp_mem = num_images;
							num_images_tvin_wrapc_buffer.range(31, 0) = num_images_tmp_mem.range(31, 0);
						}
					}
				}
			}
		...
		for (int i = 0; i < 1; i++)
		{
			sprintf(tvin_num_images, "%s\n", (num_images_tvin_wrapc_buffer).to_string(SC_HEX).c_str());
			aesl_fh.write(AUTOTB_TVIN_num_images, tvin_num_images);
		}

		tcl_file.set_num(1, &tcl_file.num_images_depth);
		sprintf(tvin_num_images, "[[/transaction]] \n");
		aesl_fh.write(AUTOTB_TVIN_num_images, tvin_num_images);
...
// [call_c_dut] ---------->
		...
		classify(in_stream, out_stream, num_images);
     ...
     aesl_tmp_3.clear();
		...
		sc_bv<64>* in_stream_V_data_V_tvin_wrapc_buffer = new sc_bv<64>[aesl_tmp_1 - aesl_tmp_2];
		...
		// RTL Name: in_stream_V_data_V
		{
			...
			{
				int hls_map_index = 0;
				// celement: in_stream.V.data.V(63, 0)
				{
					...
					for (int i_0 = 0; i_0 <= aesl_tmp_1 - aesl_tmp_2 - 1; i_0 += 1)
					{
						...
						for (int i_1 = 0; i_1 <= 0; i_1 += 1)
						{
							...
							{
								sc_lv<64> in_stream_V_data_V_tmp_mem;
								in_stream_V_data_V_tmp_mem = (aesl_tmp_0[i_0].data).to_string(2).c_str();
								in_stream_V_data_V_tvin_wrapc_buffer[hls_map_index].range(63, 0) = in_stream_V_data_V_tmp_mem.range(63, 0);
                                 		       hls_map_index++;
							}
						}
					}
		...
		sc_bv<8>* in_stream_V_keep_V_tvin_wrapc_buffer = new sc_bv<8>[aesl_tmp_1 - aesl_tmp_2];
		...
		// RTL Name: in_stream_V_keep_V
		{
			...
			{
				int hls_map_index = 0;
				// celement: in_stream.V.keep.V(7, 0)
				{
					// carray: (0) => (aesl_tmp_1 - aesl_tmp_2 - 1) @ (1)
					for (int i_0 = 0; i_0 <= aesl_tmp_1 - aesl_tmp_2 - 1; i_0 += 1)
					{
						...
						for (int i_1 = 0; i_1 <= 0; i_1 += 1)
						{
							...
							{
								sc_lv<8> in_stream_V_keep_V_tmp_mem;
								in_stream_V_keep_V_tmp_mem = (aesl_tmp_0[i_0].keep).to_string(2).c_str();
								in_stream_V_keep_V_tvin_wrapc_buffer[hls_map_index].range(7, 0) = in_stream_V_keep_V_tmp_mem.range(7, 0);
                                 		       hls_map_index++;
							}
						}
					}
		...
		sc_bv<8>* in_stream_V_strb_V_tvin_wrapc_buffer = new sc_bv<8>[aesl_tmp_1 - aesl_tmp_2];
		...
		// RTL Name: in_stream_V_strb_V
		{
			...
			{
				int hls_map_index = 0;
				// celement: in_stream.V.strb.V(7, 0)
				{
					// carray: (0) => (aesl_tmp_1 - aesl_tmp_2 - 1) @ (1)
					for (int i_0 = 0; i_0 <= aesl_tmp_1 - aesl_tmp_2 - 1; i_0 += 1)
					{
						...
						for (int i_1 = 0; i_1 <= 0; i_1 += 1)
						{
							...
							{
								sc_lv<8> in_stream_V_strb_V_tmp_mem;
								in_stream_V_strb_V_tmp_mem = (aesl_tmp_0[i_0].strb).to_string(2).c_str();
								in_stream_V_strb_V_tvin_wrapc_buffer[hls_map_index].range(7, 0) = in_stream_V_strb_V_tmp_mem.range(7, 0);
                                 		       hls_map_index++;
							}
						}
					}
					...
					for (int i_0 = aesl_tmp_5; i_0 <= aesl_tmp_4 - 1; i_0 += 1)
					{
						...
						for (int i_1 = 0; i_1 <= 0; i_1 += 1)
						{
							...
							if (&(aesl_tmp_3[0].data) != NULL) // check the null address if the c port is array or others
							{
								...
								out_stream_V_data_V_tmp_mem = (aesl_tmp_3[i_0].data).range().to_string(SC_BIN).c_str();
		...
		sc_bv<1>* out_stream_V_keep_V_tvout_wrapc_buffer = new sc_bv<1>[aesl_tmp_4 - aesl_tmp_5];
				...
				// celement: out_stream.V.keep.V(0, 0)
				{
					...
					for (int i_0 = aesl_tmp_5; i_0 <= aesl_tmp_4 - 1; i_0 += 1)
					{
						...
						for (int i_1 = 0; i_1 <= 0; i_1 += 1)
						{
							...
							if (&(aesl_tmp_3[0].keep) != NULL) // check the null address if the c port is array or others
							{
								sc_lv<1> out_stream_V_keep_V_tmp_mem;
								out_stream_V_keep_V_tmp_mem = (aesl_tmp_3[i_0].keep).to_string(2).c_str();
								out_stream_V_keep_V_tvout_wrapc_buffer[hls_map_index].range(0, 0) = out_stream_V_keep_V_tmp_mem.range(0, 0);
                                 		       hls_map_index++;
							}
						}
					}
		...
		sc_bv<1>* out_stream_V_strb_V_tvout_wrapc_buffer = new sc_bv<1>[aesl_tmp_4 - aesl_tmp_5];
				...
				// celement: out_stream.V.strb.V(0, 0)
				{
					...
					for (int i_0 = aesl_tmp_5; i_0 <= aesl_tmp_4 - 1; i_0 += 1)
					{
						...
						for (int i_1 = 0; i_1 <= 0; i_1 += 1)
						{
							...
							if (&(aesl_tmp_3[0].strb) != NULL) // check the null address if the c port is array or others
							{
								sc_lv<1> out_stream_V_strb_V_tmp_mem;
								out_stream_V_strb_V_tmp_mem = (aesl_tmp_3[i_0].strb).to_string(2).c_str();
								out_stream_V_strb_V_tvout_wrapc_buffer[hls_map_index].range(0, 0) = out_stream_V_strb_V_tmp_mem.range(0, 0);
                                 		       hls_map_index++;
							}
						}
					}
		...
		// release memory allocation: "num_images"
		delete [] tvin_num_images;
