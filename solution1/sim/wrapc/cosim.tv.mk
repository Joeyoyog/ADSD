...
$(ObjDir)/AcceleratorTB.cpp_pre.cpp.tb.o : AcceleratorTB.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling AcceleratorTB.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
...
$(ObjDir)/Exp.cpp_pre.cpp.tb.o : Exp.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling Exp.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
	$(Verb) $(CC) ${CCFLAG} ${TOOLCHAIN}  -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG) $< -o $@; \
